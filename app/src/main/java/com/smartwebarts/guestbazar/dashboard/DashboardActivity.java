...
import com.smartwebarts.guestbazar.wishlist.WishListActivity;
import com.smartwebarts.guestbazar.cart.CartActivity;
...
//                .setDomainUriPrefix("https://example.page.link")
    ...
    private void getCartList() {
        ...
        class GetTasks extends AsyncTask<Void, Void, ArrayList<com.smartwebarts.guestbazar.database.Task>> {

            @Override
            protected ArrayList<com.smartwebarts.guestbazar.database.Task> doInBackground(Void... voids) {
                List<com.smartwebarts.guestbazar.database.Task> tasks = DatabaseClient.getmInstance(getApplicationContext())
                        .getAppDatabase()
                        .taskDao()
                        .getAll();
            ...
            @Override
            protected void onPostExecute(ArrayList<com.smartwebarts.guestbazar.database.Task> tasks) {
