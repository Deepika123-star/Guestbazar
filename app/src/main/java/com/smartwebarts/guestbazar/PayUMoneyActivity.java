...
public class PayUMoneyActivity extends AppCompatActivity {
     ...
     */
    int mId;
    private String mMerchantKey = "oXp4WsMJ";//For merchant and salt key you need to contact payu money tech support otherwise you get error
    private String mSalt = "XV2FAmcfQ1";//copy and paste works fine
